...
final class Router
{
  ...
  public static string $controller_namespace = '\\CarlBennett\Tools\\Controllers\\';
  public static string $global_namespace = '\\CarlBennett\Tools\\';
  public static string $view_namespace = '\\CarlBennett\Tools\\Views\\';
  ...
  protected static function invokeController(\CarlBennett\Tools\Interfaces\Controller $controller, string $view, ?array $args): void
  {
  ...
  protected static function negotiateView(array $route_views): string
  {
    ...
    foreach ($route_views as $view_class)
    {
      ...
      if (!\class_exists($view_class)) throw new \CarlBennett\Tools\Exceptions\InvalidViewException($view_class);
